export const textConstants = {
  HERO_SECTION_WELCOME_CHIP_TEXT:
    "Welcome to ThriveStack's Sample application - Acme Labs",
  HERO_SECTION_TITLE_PART_ONE: "Acme Labs",
  ...
  PRICING_SECTION_TITLE: "Pricing Section of Acme Labs",
